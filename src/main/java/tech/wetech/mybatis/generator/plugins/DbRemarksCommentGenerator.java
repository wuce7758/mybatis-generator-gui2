...
public class DbRemarksCommentGenerator implements CommentGenerator {
    ...
    public void addJavaFileComment(CompilationUnit compilationUnit) {
        ...
        if (isAnnotations) {
            compilationUnit.addImportedType(new FullyQualifiedJavaType("javax.persistence.TableVO"));
    ...
    public void addModelClassComment(TopLevelClass topLevelClass,
        ...
        topLevelClass.addJavaDocLine(" */");
        if(isAnnotations) {
            topLevelClass.addAnnotation("@TableVO(name=\"" + introspectedTable.getFullyQualifiedTableNameAtRuntime() + "\")");
        }
    }
